  ...
  return (
    <div className="flex flex-col md:flex-row items-center gap-6 p-6 rounded-xl bg-gradient-to-br from-tm-bg-dark to-surface">
      <div className="flex-1">
        ...
        <p className="text-slate-400 mt-2 max-w-xl">Transform your data into actionable insights with real-time monitoring and beautiful visualizations.</p>
      ...
      <div className="flex-1 w-full md:w-auto">
        <div className="h-36 md:h-40 rounded-lg bg-gradient-to-b from-[#0f1329] to-[#0a0e27] border border-white/5" aria-hidden />
      </div>
    </div>
  )
}
