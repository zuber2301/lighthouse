...
import { fetchRecognitions, createRecognition } from '../src/api/recognitions'
...
describe('useRecognitions', () => {
  ...
  test('creates recognition successfully', async () => {
    ...
    // Verify optimistic update was applied and then reverted on success
    expect(fetchRecognitions).toHaveBeenCalledTimes(2) // Initial load + invalidation
  })
