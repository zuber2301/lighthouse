...
export default function Header() {
  ...
  return (
    <header className={`flex items-center justify-between px-6 py-3 border-b border-slate-800 bg-surface ${styles.header}`}>
      ...
      <div className="flex items-center gap-4">
        <button className="px-3 py-1 rounded-md text-sm bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus-visible:ring-3 focus-visible:ring-primary">New Recognition</button>
