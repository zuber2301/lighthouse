  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <select 
        ...
        onChange={onChange} 
        className="text-[16px] font-bold bg-indigo-500/5 border border-indigo-500/20 text-text-main px-4 py-1.5 rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all hover:bg-indigo-500/10 active:scale-95 cursor-pointer appearance-none pr-8 relative"
        style={{
