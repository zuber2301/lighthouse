    ...
    <div className="space-y-6">
      ...
      <div className="mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <button type="button" className="bg-[rgba(255,255,255,0.03)] border border-white/6 rounded-xl p-4 text-center hover:-translate-y-1 transform transition-all duration-200 hover:shadow-tm-neon focus:outline-none focus-visible:ring-2 focus-visible:ring-tm-teal">
            ...
            <p className="text-sm text-slate-400 mt-2">Accuracy in predictive analytics and business forecasting models.</p>
          </button>
          ...
          <button type="button" className="bg-[rgba(255,255,255,0.03)] border border-white/6 rounded-xl p-4 text-center hover:-translate-y-1 transform transition-all duration-200 hover:shadow-tm-neon focus:outline-none focus-visible:ring-2 focus-visible:ring-tm-teal">
            ...
            <p className="text-sm text-slate-400 mt-2">Mobile app downloads and active user engagement metrics.</p>
          </button>
          ...
          <button type="button" className="bg-[rgba(255,255,255,0.03)] border border-white/6 rounded-xl p-4 text-center hover:-translate-y-1 transform transition-all duration-200 hover:shadow-tm-neon focus:outline-none focus-visible:ring-2 focus-visible:ring-tm-teal">
            ...
            <p className="text-sm text-slate-400 mt-2">Countries actively using our analytics platform worldwide.</p>
          </button>
          ...
          <button type="button" className="bg-[rgba(255,255,255,0.03)] border border-white/6 rounded-xl p-4 text-center hover:-translate-y-1 transform transition-all duration-200 hover:shadow-tm-neon focus:outline-none focus-visible:ring-2 focus-visible:ring-tm-teal">
            ...
            <p className="text-sm text-slate-400 mt-2">Comprehensive performance scoring across all platform metrics.</p>
          </button>
        </div>
      </div>
    </div>
