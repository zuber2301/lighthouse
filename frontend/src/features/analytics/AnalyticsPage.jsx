    ...
    <div className="space-y-6">
      ...
      <div className="mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <button type="button" className="bg-card border border-indigo-500/10/5 border border-indigo-500/10 rounded-xl p-4 text-center hover:-translate-y-1 transform transition-all duration-200 hover:shadow-sm-tm-neon focus:outline-none focus-visible:ring-2 focus-visible:ring-tm-teal">
