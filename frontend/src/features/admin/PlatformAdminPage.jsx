      ...
      <div className="flex justify-between items-end">
        ...
        <div className="flex gap-3 mb-8">
          <button 
            ...
            className="px-5 py-2.5 rounded-lg bg-indigo-500/5 border border-indigo-500/10 text-text-main text-[13px] font-normal uppercase tracking-widest hover:bg-indigo-500/10 transition-all shadow-lg active:scale-95"
          >
            System Logs
          </button>
          <button 
            onClick={() => navigate('/platform-admin/subscriptions')}
            className="px-5 py-2.5 rounded-lg btn-accent text-[13px] font-normal uppercase tracking-widest hover:brightness-95 transition-all shadow-xl shadow-indigo-600/20 active:scale-95"
          >
            Pricing Engine
          </button>
        </div>
