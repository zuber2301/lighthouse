...
export default function GroupAwardWizard({ open = true, onClose = () => {}, onSubmit = async () => {} }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-6">
      <div className="w-full max-w-4xl bg-[#661d66] border border-blue-500/30 rounded-lg overflow-hidden shadow-2xl shadow-blue-500/20 transition-colors duration-500">
