# Lighthouse — Full Feature Catalog & Implementation Details

This document is a **complete, module-by-module implementation reference** for Lighthouse. Each feature includes:
...
Key endpoints (see `ENDPOINTS_LIGHTHOUSE.md`):
...
Key endpoints (from `ENDPOINTS_LIGHTHOUSE.md`):
- `GET /user/search`
- `GET /user/points`
- `GET /tenant/users`
